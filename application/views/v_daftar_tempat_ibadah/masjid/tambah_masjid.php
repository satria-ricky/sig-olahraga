    ...
    <div class="card">
            <div class="card-header">
              ...
              <div class="card-body">
                ...
                <?= form_open_multipart('c_tempat_ibadah/tambahMasjid'); ?>
                  ...
                  <div class="form-group ">
                            ...
                            <?= form_error('scrolltip', '<small class="text-danger">', '</small>'); ?>
                  </div>

                  <label for="basic-url">Nama Masjid</label>
                  <div class="form-group ">
                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="nama_masjid" value="<?= set_value('nama_masjid'); ?>">
...
<div class="card">
    <div class="card-body">
                  ...
                  <div class="form-group ">
                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="status_tanah" value="<?= set_value('status_tanah'); ?>">
                  </div>
                  ...
                  <div class="form-group ">
                    <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="tahun_berdiri" value="<?= set_value('tahun_berdiri'); ?>">
                  </div>

                  <label for="basic-url">Jamaah</label>
                  <div class="form-group ">
                    <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="jamaah" value="<?= set_value('luas_bangunan'); ?>">
                  </div>

                  <label for="basic-url">Imam</label>
                  <div class="form-group ">
                    <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="imam" value="<?= set_value('imam'); ?>">
                  </div>

                  <label for="basic-url">Khatib</label>
                  <div class="form-group ">
                    <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="khatib" value="<?= set_value('khatib'); ?>">
                  </div>

                  <label for="basic-url">Remaja</label>
                  <div class="form-group ">
                    <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="remaja" value="<?= set_value('remaja'); ?>">
                  </div>

                  <label for="basic-url">No. Telepon</label>
                  <div class="form-group ">
                    <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="telepon" value="<?= set_value('telepon'); ?>">
                  </div>
