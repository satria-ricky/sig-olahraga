        ...
        <div class="container-fluid">
          ...
          <a href="<?= base_url('c_tempat_ibadah/gereja'); ?>" class="btn btn-info mb-2"><i class="fa fa-arrow-left"></i> Kembali</a>
            <!-- <h3 class="font-weight-bold mt-3">Edit data gereja</h3> -->
  ...
  <div class="col-sm-5">
    ...
    <div class="card">
            ...
            <?= form_open_multipart(); ?>
              ...
              <label for="basic-url">Nama Gereja</label>
              ...
              <div class="form-group ">
                <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="keterangan" value="<?= $tempat_ibadah['ti_keterangan'];?>">
              </div>
