        ...
        <div class="container-fluid">
          ...
          <a href="<?= base_url('c_tempat_ibadah/gereja'); ?>" class="btn btn-info mb-2"><i class="fa fa-arrow-left"></i> Lihat data gereja</a>
            <!-- <h3 class="font-weight-bold mt-3">Tambah data gereja</h3> -->
...
<div class="row">
  ...
  <div class="col-sm-5">
    ...
    <div class="card">
            ...
            <div class="card-body">
                <?= form_open_multipart('c_tempat_ibadah/tambahGereja'); ?>
                ...
                <div class="form-group mb-3">
                  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="keterangan" value="<?= set_value('keterangan'); ?>">
                </div>
