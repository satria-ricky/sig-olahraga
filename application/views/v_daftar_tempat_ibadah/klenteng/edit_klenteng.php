        ...
        <div class="container-fluid">
          ...
          <a href="<?= base_url('c_tempat_ibadah/klenteng'); ?>" class="btn btn-info mb-2"><i class="fa fa-arrow-left"></i> Kembali</a>
            <!-- <h3 class="font-weight-bold mt-3">Edit data klenteng</h3> -->
    ...
    <div class="card">
            ...
            <div class="card-body">
              ...
              <?= form_open_multipart(); ?>
                ...
                <label for="basic-url">Nama Klenteng</label>
              ...
              <div class="btn-group">
                ...
                <div class="form-group ">
                  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="ketua" value="<?= $tempat_ibadah['ti_ketua'];?>">
                  <?= form_error('ketua', '<small class="text-danger">', '</small>'); ?>
                </div>

                <label for="basic-url">Di bawah binaan majelis</label>
                <div class="form-group ">
                  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="binaan_majelis" value="<?= $tempat_ibadah['ti_binaan_majelis'];?>">
