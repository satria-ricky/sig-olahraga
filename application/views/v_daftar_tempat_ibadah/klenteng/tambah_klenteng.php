        ...
        <div class="container-fluid">
          ...
          <a href="<?= base_url('c_tempat_ibadah/klenteng'); ?>" class="btn btn-info mb-2"><i class="fa fa-arrow-left"></i> Lihat data klenteng</a>
            <!-- <h3 class="font-weight-bold mt-3">Tambah data klenteng</h3> -->
    ...
    <div class="card">
            <div class="card-header">
             ...
             <div class="card-body">
              ...
              <?= form_open_multipart('c_tempat_ibadah/tambahKlenteng'); ?>
