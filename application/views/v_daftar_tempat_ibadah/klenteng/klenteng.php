        ...
        <div class="container-fluid">
          ...
          <!-- <h3 class="ml-2 mb-3 font-weight-bold ">Daftar Klenteng</h3> -->
            ...
            <div class="row">
              ...
              <div class="btn-group ml-auto">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="<?= base_url('c_tempat_ibadah/format_klenteng'); ?>">Unduh format excel</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal_import"><p class="fa fa-upload"></p> Import Excel</a>
                  <a class="dropdown-item" href="<?= base_url('c_tempat_ibadah/tambahKlenteng'); ?>"> <p class="fa fa-plus"></p> Tambah data</a>
                </div>
              </div>
              ...
              <div class="btn-group ml-2">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="<?= base_url('c_tempat_ibadah/export_klenteng'); ?>">Export Excel</a>
                </div>
              </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Import Data Klenteng</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <?= form_open_multipart('c_tempat_ibadah/import_klenteng'); ?>
...
<?php foreach($list_tempat_ibadah as $ti ) : ?>
  ...
  <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Detail Data Klenteng</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<script type="text/javascript">
    ...
    function getData(kab){
      $.ajax({
            url: "<?php echo base_url(); ?>c_tempat_ibadah/load_klenteng",
            type: "post",
            data: {
                id_kab: kab
            },
                 ...
                 $('#data_tabel').DataTable( {
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            return `
                              <a href="${row.ti_id}" class="badge badge-primary" data-toggle="modal" data-target="#modal_detail${row.ti_id}" >Detail</a> <a href='<?= base_url('c_tempat_ibadah/edit_klenteng/')?>${row.ti_id}' class="badge badge-success">Edit</a> <a href='<?= base_url('c_tempat_ibadah/hapus_klenteng/')?>${row.ti_id}' class="badge badge-danger" onclick="return confirm('Yakin dihapus?');">Hapus</a>
                            `;
                            }
                        }
                    ]
