...
class C_vihara extends REST_Controller 
{
    ...
    public function index_get()
    {
        ...
        if ($v_id === null) {
            $v_tempat_ibadah['list_tempat_ibadah']  = $this->M_tempat_ibadah->selectVihara();
        }else {
            $v_tempat_ibadah['list_tempat_ibadah']  = $this->M_tempat_ibadah->selectViharaByKab($v_id);
        }
